...
public class GetThrown : MonoBehaviour
{
    /// <summary>
    /// Public fields
    /// </summary>
    public float m_Speed = 3f;   // this is the projectile's speed
    public float m_Lifespan = 5f; // this is the projectile's lifespan (in seconds)
